...
export function renderHistory(records = []) {
  const content = records.length === 0
    ? `<div class="empty-state"><span>◇</span><h2>尚无卦录</h2><p>完成一次起卦后，本地不可变结果会保存在当前浏览器，并显示云端 AI 状态。</p><a class="primary-action" href="#/ask"><span>诚心问易</span></a></div>`
  ...
  return `<section class="secondary-view" aria-labelledby="history-title"><header class="view-heading"><p>本地卦录 · 云端深解状态</p><h1 id="history-title">卦录</h1><span>共 ${records.length} 条</span></header>${content}</section>`;
}
